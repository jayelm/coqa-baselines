...
def get_args():
    ...
    group.add_argument('--hidden_size', type=int, default=50, help='Set hidden size.')
    group.add_argument('--num_layers', type=int, default=1, help='Number of layers for document/question encoding.')
