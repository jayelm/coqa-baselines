...
import os
import random
import modeling_tf as modeling
import optimization_tf as optimization
import tokenization
import six
...
def model_fn_builder(bert_config, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    history_features = features["history_features"]
...
def input_fn_builder(input_file, seq_length, n_history_f, is_training, drop_remainder):
...
def main(_):
  ...
  if FLAGS.do_train:
    train_examples, cfg = bdu.read_coqa_examples(
        input_file=FLAGS.train_file, is_training=True, return_config=True)
    n_history_f = cfg['num_features']
    num_train_steps = int(
  ...
  if FLAGS.do_train:
    ...
    train_writer = FeatureWriter(
        ...
        is_training=True)
    bdu.convert_coqa_examples_to_features(
  ...
  if FLAGS.do_predict:
    eval_examples, cfg = bdu.read_coqa_examples(
